  ...
  class Page{
    ...
    function showPage($nowPage,$pageSize){
    	...
    	// Select * from 表名 limit ($nowPage-1)*$pageSize,$pageSize
      	...
      	$datas=$this->tableObject->limit("{$limit},{$pageSize}")->select();
    ...
    private function firstPage(){
       if ($this->nowPage<=1) {
          ...
          echo "&nbsp;&nbsp;&nbsp<a href='javascript:pagejs(1)'>首页</a>";
       }
    }
    // 显示上一页
    private function prePage(){
       if ($this->nowPage<=1) {
          ...
          echo "&nbsp;&nbsp;&nbsp<a href='javascript:pagejs({$nowPage})'>上一页</a>";
       }
    }
    // 显示下一页
     private function nextPage(){
       if ($this->nowPage>=$this->pageCount) {
          ...
          $nowPage=$this->nowPage+1;
          echo "&nbsp;&nbsp;&nbsp<a href='javascript:pagejs({$nowPage})'>下一页</a>";
       }
    }
      // 显示尾页
     private function lastPage(){
       if ($this->nowPage>=$this->pageCount) {
          ...
          echo "&nbsp;&nbsp;&nbsp<a href='pagejs({$this->pageCount})'>尾页</a>";
       }
    }
